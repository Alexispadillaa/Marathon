Proyecto de análisis exploratorio de datos usando pandas para el manejo y manipulación de datos y la librería seaborn para la graficación de los mismos. 
